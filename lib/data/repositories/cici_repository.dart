...
class CiciRepository extends BaseRepository {
  ...
  Future<ApiResult> getAiImages() async {
    Map<String, String> headers = {
      ...
      'priority': 'u=1, i',
      'referer':
          'https://www.ciciai.com/chat/create-image?from_login=1&origin_landing=https%3A%2F%2Fwww.ciciai.com%2F%3Ffrom_logout%3D1%26loginSuccessBackUrl%3D%252Fchat%252Fcreate-image',
      'sec-ch-ua':
