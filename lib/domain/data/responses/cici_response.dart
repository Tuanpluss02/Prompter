...
part '../../../generated/domain/data/responses/cici_response.g.dart';
...
class CiciResponse {
  ...
  factory CiciResponse.fromJson(Map<String, dynamic> json) => _$CiciResponseFromJson(json);

  Map<String, dynamic> toJson() => _$CiciResponseToJson(this);
}
