...
class SuggestionItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final suggestionsConfig = context.suggestionsConfig ?? const ReplySuggestionsConfig();
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: suggestionItemData.config?.padding ?? suggestionsListConfig?.padding ?? const EdgeInsets.all(6),
        ...
        child: Text(
          ...
          style: suggestionItemData.config?.textStyle ?? suggestionsListConfig?.textStyle,
        ),
      ),
    );
  }
