...
class DarkChatTheme extends ChatTheme {
  DarkChatTheme({
    ...
    Color super.backgroundColor = AppColors.backgroundColor,
    ...
    Color super.outgoingChatBubbleColor = AppColors.primaryColor,
    Color super.inComingChatBubbleColor = AppColors.appColorPrimary,
